<script>
    function all(result,element,div){
        ...
        if(operatorName!="" || industry!="" && department1 == ""){
        ...
        function selectHandler(e) {
            ...
            if(selection.length){
                ...
                if(operatorOperation==0){
                    ...
                    month="";
                    quarter="";
                    tittles= operatorName+clientName+industry+' Amount by Year';
                    xtittles= 'year';
                ...
                if(operatorOperation==1){
                    ...
                    month="";
                    quarter="YES";
                    tittles= operatorName+clientName+industry+' Amount by Quarter : '+year;
                ...
                //Total Ammount of Selected Year's  Month  VS Selected Year's  month
                    ...
                    month="";
                    quarter="";
                    tittles= operatorName+clientName+industry+' Amount by Month : '+year;
                ...
                //Total Ammount of Selected Year => Month => Day VS Selected Year => Month => Day
                    ...
                    month=str0;
                    quarter="";
                    tittles= operatorName+clientName+industry+' Amount by Day: '+mL[str0-1]+' '+year;
                    xtittles= 'days of : '+mL[str0-1]+', '+ year;
                }
                else if(operatorOperation==4 && operatorName!="Local" && operatorName!="International"){
                    year="";
                    month="";
                    quarter="";
                    tittles= operatorName+clientName+industry+' Amount by Year';
    ...
    function alls(result,element, div){
        ...
        var options = {
            ...
            legend: { position: 'none' },
            diff: { oldData: {
                    title: 'hello', opacity: 1, color: '#F9E79F',
                    tooltip:{
                        prefix:'total amount'
                    }
                },
                newData: {
                    opacity: 1, widthFactor: 1,
                    tooltip:{
                        prefix: operatorName+' amount'
                    }
                }
        ...
        //     if(selection.length){
        //         var item = selection[0];
        //         var alert1 = data.getFormattedValue(item.row, 0);
        //         var alert2 = data.getFormattedValue(item.row, 1);
        //         var alert3 = data.getFormattedValue(item.row, 2);
        //         var alert4 = data.getFormattedValue(item.row, 3);
        //     }
